...
void GetPeaksLaBr()
{
    ...
    string fout_name = "Peaks_labr.dat";
    system("xterm -e 'mkdir mama_spectra_labr'"); // create dir for mama spectra, if not already existend
    string outdir = "mama_spectra_labr";
