...
void PhysicsList::ConstructOptical() {
	...
	G4OpAbsorption* absorption = new G4OpAbsorption("Absorption");
	G4OpRayleigh* rayleigh = new G4OpRayleigh("Rayleigh");
	//	G4OpBoundaryProcess* boundary = new G4OpBoundaryProcess("Boundary");
	...
	cerenkov->SetMaxNumPhotonsPerStep(20);
